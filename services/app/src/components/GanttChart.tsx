...
export function GanttChart({ nodes, sprints, currentSprintId }: Readonly<GanttChartProps>) {
  ...
  return (
    <div className="card-planner gantt-container">
      ...
      <div className="gantt-scroll-area">
        <div className="gantt-content" style={{ '--gantt-min-width': `${days.length * 40 + 280}px` } as React.CSSProperties}>
